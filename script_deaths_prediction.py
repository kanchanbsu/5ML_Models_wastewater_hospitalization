...
# Load wastewatercounts and Deaths data

import pandas as pd

df = pd.read_csv("wastewater_death.csv")
...
plt.title("Test Data: Actual vs Predicted Deaths (All Models)")
...
# SVR: Observed vs Predicted Deaths
import matplotlib.pyplot as plt
...
plt.ylabel("Predicted Deaths (SVR)")
